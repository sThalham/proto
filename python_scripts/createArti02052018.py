...
if __name__ == "__main__":
    ...
    for fileInd in os.listdir(root):
        if fileInd.endswith(".yaml"):
            ...
            if rnd == 1:
                ...
                imgPath = '/home/sthalham/data/T-less_Detectron/tlessArti03052018/train/' + redname + '.jpg'
                imgID = int(redname)
                imgName = redname + '.jpg'
    ...
    traAnno = "/home/sthalham/data/T-less_Detectron/tlessArti03052018/annotations/instances_train_tless.json"
