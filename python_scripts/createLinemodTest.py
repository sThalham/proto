...
if __name__ == "__main__":
    ...
    for s in sub:
        ...
        for ss in subsub:
            ...
            fileName = '/home/sthalham/data/T-less_Detectron/linemodTestHAA/val/' + imgNam
            ...
            if rnd == 1:
                ...
                if myFile.exists():
                    print('skipping imwrite')
                else:
                    depthName = '/home/sthalham/data/T-less_Detectron/linemodTestHAA/val/' + imgNam
    ...
    valAnno = "/home/sthalham/data/T-less_Detectron/linemodTestHAA/annotations/instances_val_tless.json"
