...
def manipulate_depth(fn_gt, fn_depth, fn_part):
    ...
    # depthFinal = cv2.GaussianBlur(depthFinal, (9, 9), 2.5, 2.5)
...
if __name__ == "__main__":
    ...
    for fileInd in os.listdir(root):
        if fileInd.endswith(".yaml"):
            ...
            for ind, curNoise in enumerate(addNoise):
                ...
                depth_blur = cv2.GaussianBlur(depth_refine, (9, 9), curNoise, curNoise)
                ...
                if rnd == 1:
                    ...
                    imgPath = '/home/sthalham/data/T-less_Detectron/tlessArti04052018/train/' + newredname + '.jpg'
    ...
    traAnno = "/home/sthalham/data/T-less_Detectron/tlessArti04052018/annotations/instances_train_tless.json"
