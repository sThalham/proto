...
if __name__ == "__main__":
    ...
    for s in sub:
        ...
        for ss in subsub:
            ...
            if rnd == 1:
                ...
                depthName = '/home/sthalham/data/T-less_Detectron/tless_Test_split/val/' + imgNam
                ...
                depthName = '/home/sthalham/data/T-less_Detectron/tless_Test_split/train/' + imgNam
                # rgbName = '/home/sthalham/data/T-less_Detectron/tlessC_all/val/' + imgNam
                cv2.imwrite(depthName, imgI)
                # cv2.imwrite(rgbName, rgbImg)
    ...
    valAnno = "/home/sthalham/data/T-less_Detectron/tless_Test_split/annotations/instances_val_tless.json"
    trainAnno = "/home/sthalham/data/T-less_Detectron/tless_Test_split/annotations/instances_train_tless.json"
