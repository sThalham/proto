...
sample_dir = '/home/sthalham/data/t-less_mani/proto' #directory for temporary files (cam_L, cam_R, masks..~)
target_dir = '/home/sthalham/data/t-less_mani/proto/patches'
index=0
isfile=True
while isfile:
